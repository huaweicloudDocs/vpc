...
4.  在“创建虚拟私有云”页面，根据界面提示配置虚拟私有云参数。
    ...
    **表 2**  子网参数说明
    ...
    <td class="cellrowborder" valign="top" width="42.425757424257576%" headers="mcps1.2.4.1.2 "><p id="p1692764216320"><a name="p1692764216320"></a><a name="p1692764216320"></a>可用区是指在同一地域内，电力和网络互相独立的物理区域。在同一VPC网络内可用区与可用区之间内网互通，可用区之间能做到物理隔离。详细信息请参见<a href="https://support.huaweicloud.com/productdesc-vpc/overview_region.html" target="_blank" rel="noopener noreferrer">区域和可用区</a>。</p>
