...
5.  在“创建虚拟私有云”页面，根据界面提示配置虚拟私有云参数。
    ...
    **表 2**  子网参数说明
    ...
    <td class="cellrowborder" valign="top" width="42.425757424257576%" headers="mcps1.2.4.1.2 "><p id="p3915353111515"><a name="p3915353111515"></a><a name="p3915353111515"></a>可用区是指在同一地域内，电力和网络互相独立的物理区域。在同一VPC网络内可用区与可用区之间内网互通，可用区之间能做到物理隔离。详细信息请参见<a href="https://support.huaweicloud.com/productdesc-vpc/overview_region.html" target="_blank" rel="noopener noreferrer">区域和可用区</a>。</p>
    <p id="p296014842316"><a name="p296014842316"></a><a name="p296014842316"></a>子网对可用区无强制约束，资源实例与子网的可用区无需保持一致。用户可通过可用区实现跨可用区的高可用。</p>
    </td>
    ...
    <tr id="row591611538154"><td class="cellrowborder" valign="top" width="19.768023197680233%" headers="mcps1.2.4.1.1 "><p id="p19916125381517"><a name="p19916125381517"></a><a name="p19916125381517"></a>NTP服务器地址</p>
    </td>
    <td class="cellrowborder" valign="top" width="42.425757424257576%" headers="mcps1.2.4.1.2 "><p id="p821820171312"><a name="p821820171312"></a><a name="p821820171312"></a>NTP时间服务器IP地址，非必填项。</p>
    ...
    <p id="p123731259162218"><a name="p123731259162218"></a><a name="p123731259162218"></a>目前仅“华南-广州”、“拉美-圣地亚哥”支持。</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="42.425757424257576%" headers="mcps1.2.4.1.2 "><p id="p16917153181517"><a name="p16917153181517"></a><a name="p16917153181517"></a>DHCP租约时间是指DHCP服务器自动分配给客户端的IP地址的使用期限。超过租约时间，IP地址将被收回，需要重新分配。单位：天或者小时。</p>
    ...
    <tr id="row149171653111519"><td class="cellrowborder" valign="top" width="19.768023197680233%" headers="mcps1.2.4.1.1 "><p id="p8917135316152"><a name="p8917135316152"></a><a name="p8917135316152"></a>描述</p>
    </td>
    <td class="cellrowborder" valign="top" width="42.425757424257576%" headers="mcps1.2.4.1.2 "><p id="p109171953171512"><a name="p109171953171512"></a><a name="p109171953171512"></a>子网的描述信息，非必填项。</p>
