...
5.  根据界面提示配置参数。
    ...
    **表 1**  参数说明
    ...
    <td class="cellrowborder" valign="top" width="25.040000000000003%" headers="mcps1.2.4.1.3 "><a name="ul11512059172714"></a><a name="ul11512059172714"></a><ul id="ul11512059172714"><li>键：Ipv4_key1</li><li>值：192.168.12.10</li></ul>
    </td>
    </tr>
