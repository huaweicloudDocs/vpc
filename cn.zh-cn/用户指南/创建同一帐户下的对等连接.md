...
5.  根据界面提示配置参数，其中“帐户”选择“当前帐户”，相关参数如[表1](#table1215761020244)所示。
    ...
    **表 1**  参数说明
    ...
    <tr id="row171574104240"><td class="cellrowborder" valign="top" width="22.38223822382238%" headers="mcps1.2.4.1.1 "><p id="p11157131014249"><a name="p11157131014249"></a><a name="p11157131014249"></a>描述</p>
    </td>
    <td class="cellrowborder" valign="top" width="43.884388438843885%" headers="mcps1.2.4.1.2 "><p id="p1915791012418"><a name="p1915791012418"></a><a name="p1915791012418"></a>对等连接的描述信息，非必填项。</p>
    <p id="p11157121012247"><a name="p11157121012247"></a><a name="p11157121012247"></a>描述信息内容不能超过255个字符，且不能包含“&lt;”和“&gt;”。</p>
    </td>
    <td class="cellrowborder" valign="top" width="33.73337333733373%" headers="mcps1.2.4.1.3 "><p id="p1215701012244"><a name="p1215701012244"></a><a name="p1215701012244"></a>-</p>
    </td>
    </tr>
    </tbody>
    </table>
