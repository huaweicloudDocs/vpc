...
1.  查找或创建本端VPC对应的路由表，添加本端路由。参数说明如[表3](#table46361818112617)所示。

    **表 3**  参数说明

    <a name="table46361818112617"></a>
    <table><thead align="left"><tr id="row1634131816261"><th class="cellrowborder" valign="top" width="19.24%" id="mcps1.2.4.1.1"><p id="p17634618112613"><a name="p17634618112613"></a><a name="p17634618112613"></a>参数</p>
    </th>
    <th class="cellrowborder" valign="top" width="55.589999999999996%" id="mcps1.2.4.1.2"><p id="p2634141812269"><a name="p2634141812269"></a><a name="p2634141812269"></a>说明</p>
    </th>
    <th class="cellrowborder" valign="top" width="25.169999999999998%" id="mcps1.2.4.1.3"><p id="p186346187268"><a name="p186346187268"></a><a name="p186346187268"></a>取值样例</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="row963461862611"><td class="cellrowborder" valign="top" width="19.24%" headers="mcps1.2.4.1.1 "><p id="p9634161842611"><a name="p9634161842611"></a><a name="p9634161842611"></a>目的地址</p>
    </td>
    <td class="cellrowborder" valign="top" width="55.589999999999996%" headers="mcps1.2.4.1.2 "><p id="p1863411822610"><a name="p1863411822610"></a><a name="p1863411822610"></a>对端VPC的网段。</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.169999999999998%" headers="mcps1.2.4.1.3 "><p id="p463420188267"><a name="p463420188267"></a><a name="p463420188267"></a>192.168.3.0/24</p>
    </td>
    </tr>
    <tr id="row8635418152618"><td class="cellrowborder" valign="top" width="19.24%" headers="mcps1.2.4.1.1 "><p id="p106341518192619"><a name="p106341518192619"></a><a name="p106341518192619"></a>下一跳类型</p>
    </td>
    <td class="cellrowborder" valign="top" width="55.589999999999996%" headers="mcps1.2.4.1.2 "><p id="p1563414184265"><a name="p1563414184265"></a><a name="p1563414184265"></a>选择“对等连接”。</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.169999999999998%" headers="mcps1.2.4.1.3 "><p id="p1763591814268"><a name="p1763591814268"></a><a name="p1763591814268"></a>对等连接</p>
    </td>
    </tr>
    <tr id="row8635101862610"><td class="cellrowborder" valign="top" width="19.24%" headers="mcps1.2.4.1.1 "><p id="p1863515188268"><a name="p1863515188268"></a><a name="p1863515188268"></a>下一跳</p>
    </td>
    <td class="cellrowborder" valign="top" width="55.589999999999996%" headers="mcps1.2.4.1.2 "><p id="p11635101872618"><a name="p11635101872618"></a><a name="p11635101872618"></a>选择当前对等连接的名称。</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.169999999999998%" headers="mcps1.2.4.1.3 "><p id="p106358182266"><a name="p106358182266"></a><a name="p106358182266"></a>peering-002</p>
    </td>
    </tr>
    <tr id="row763616189265"><td class="cellrowborder" valign="top" width="19.24%" headers="mcps1.2.4.1.1 "><p id="p1163520185264"><a name="p1163520185264"></a><a name="p1163520185264"></a>描述</p>
    </td>
    <td class="cellrowborder" valign="top" width="55.589999999999996%" headers="mcps1.2.4.1.2 "><p id="p1635018162610"><a name="p1635018162610"></a><a name="p1635018162610"></a>路由的描述信息，非必填项。</p>
    <p id="p2063514189261"><a name="p2063514189261"></a><a name="p2063514189261"></a>描述信息内容不能超过255个字符，且不能包含“&lt;”和“&gt;”。</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.169999999999998%" headers="mcps1.2.4.1.3 "><p id="p86365181266"><a name="p86365181266"></a><a name="p86365181266"></a>-</p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   [为什么对等连接创建完成后不能互通？](http://support.huaweicloud.com/vpc_faq/vpc_faq_0069.html)
