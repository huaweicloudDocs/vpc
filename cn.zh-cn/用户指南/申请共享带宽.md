...
5.  在页面右上角，单击“购买共享带宽”，按照提示配置参数。
    ...
    **表 1**  参数说明
    ...
    <tr id="row1161714326016"><td class="cellrowborder" valign="top" width="19.24%" headers="mcps1.2.4.1.1 "><p id="p1361743210011"><a name="p1361743210011"></a><a name="p1361743210011"></a>带宽名称</p>
    </td>
    <td class="cellrowborder" valign="top" width="55.7%" headers="mcps1.2.4.1.2 "><p id="p4617332102"><a name="p4617332102"></a><a name="p4617332102"></a>共享带宽的名称。</p>
    </td>
    <td class="cellrowborder" valign="top" width="25.06%" headers="mcps1.2.4.1.3 "><p id="p4617153213012"><a name="p4617153213012"></a><a name="p4617153213012"></a>Bandwidth-001</p>
    </td>
    </tr>
