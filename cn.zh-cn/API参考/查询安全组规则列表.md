# 查询安全组规则列表<a name="ZH-CN_TOPIC_0087467070"></a>
...
```
/v1/{project_id}/security-group-rules?security_group_id=a7734e61-b545-452da3cd-
0189cbd9747a&limit=10&marker=4779ab1c-7c1a-44b1-a02e-93dfc361b32d
```
...
-   响应参数
    ...
    <td class="cellrowborder" valign="top" width="22.75%" headers="mcps1.1.4.1.2 "><p id="p115123489520"><a name="p115123489520"></a><a name="p115123489520"></a><em id="i3027703111412"><a name="i3027703111412"></a><a name="i3027703111412"></a>列表数据结构</em></p>
    </td>
    <td class="cellrowborder" valign="top" width="46.550000000000004%" headers="mcps1.1.4.1.3 "><p id="p119580209520"><a name="p119580209520"></a><a name="p119580209520"></a>安全组规则对象列表</p>
    </td>
    </tr>
    </tbody>
    </table>
