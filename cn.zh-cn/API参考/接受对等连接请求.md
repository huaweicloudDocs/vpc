# 接受对等连接请求<a name="vpc_peering_0004"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=VPC&version=v2&api=AcceptVpcPeering)中直接运行调试该接口。
...
-   响应参数
    ...
    **表 2**  响应参数
    ...
    <td class="cellrowborder" valign="top" width="23.43%" headers="mcps1.2.4.1.2 "><p id="p1425911414113"><a name="p1425911414113"></a><a name="p1425911414113"></a><a href="接受对等连接请求.md">vpc_info</a> object</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="23.43%" headers="mcps1.2.4.1.2 "><p id="p14259111441119"><a name="p14259111441119"></a><a name="p14259111441119"></a><a href="接受对等连接请求.md">vpc_info</a> object</p>
    </td>
