# 查询端口<a name="ZH-CN_TOPIC_0030591298"></a>

## 功能介绍<a name="zh-cn_topic_0030591054_section50141003"></a>

查询单个端口

## URL<a name="zh-cn_topic_0030591054_section48615844"></a>
...
-   响应参数
    ...
    **表 2**  响应参数
    ...
    <td class="cellrowborder" valign="top" width="22.68%" headers="mcps1.2.4.1.2 "><p id="p2240121716041"><a name="p2240121716041"></a><a name="p2240121716041"></a><em id="i28436916041"><a name="i28436916041"></a><a name="i28436916041"></a>字典数据结构</em></p>
    </td>
    <td class="cellrowborder" valign="top" width="54.21%" headers="mcps1.2.4.1.3 "><p id="p2303396016041"><a name="p2303396016041"></a><a name="p2303396016041"></a>端口对象</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 3**  port字段说明
    ...
    <td class="cellrowborder" valign="top" width="48.25%" headers="mcps1.2.4.1.3 "><p id="p1248865964113"><a name="p1248865964113"></a><a name="p1248865964113"></a>项目ID。</p>
    </td>
    </tr>
