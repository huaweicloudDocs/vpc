# 创建安全组<a name="ZH-CN_TOPIC_0201534218"></a>
...
-   响应参数
    ...
    **表 6**  security\_group\_rule对象
    ...
    <td class="cellrowborder" valign="top" width="45.124512451245124%" headers="mcps1.2.4.1.3 "><a name="ul8415142317513"></a><a name="ul8415142317513"></a><ul id="ul8415142317513"><li>功能说明：出入控制方向</li><li>取值范围：<a name="ul6968104419355"></a><a name="ul6968104419355"></a><ul id="ul6968104419355"><li>egress：出方向</li><li>ingress：入方向</li></ul>
    </li></ul>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="45.124512451245124%" headers="mcps1.2.4.1.3 "><a name="ul585593011517"></a><a name="ul585593011517"></a><ul id="ul585593011517"><li>功能说明：协议类型</li><li>取值范围：icmp、tcp、udp等</li><li>约束：为空表示支持所有协议</li></ul>
    </td>
    </tr>
