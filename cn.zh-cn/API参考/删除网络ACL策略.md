# 删除网络ACL策略<a name="vpc_firewall_0010"></a>

## 功能介绍<a name="section2007643132549"></a>

删除网络ACL策略。

## 调试<a name="section1062181918110"></a>

您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=VPC&version=v2&api=NeutronDeleteFirewallPolicy)中直接运行调试该接口。
...
<td class="cellrowborder" valign="top" width="36.36363636363636%" headers="mcps1.2.5.1.4 "><p id="p109701641488"><a name="p109701641488"></a><a name="p109701641488"></a><span id="text084952910464"><a name="text084952910464"></a><a name="text084952910464"></a>网络ACL</span><span id="text6849112913464"><a name="text6849112913464"></a><a name="text6849112913464"></a></span>策略唯一标识</p>
</td>
</tr>
</tbody>
</table>

## 请求消息<a name="section31261317132549"></a>

无。

## 响应消息<a name="section40411496132549"></a>

无。

## 样例<a name="section10091651132549"></a>
