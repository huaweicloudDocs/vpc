...
-   请求参数
    ...
    **表 2**  security\_group\_rule字段说明
    ...
    <td class="cellrowborder" valign="top" width="38.99%" headers="mcps1.2.5.1.4 "><a name="ul8194236156"></a><a name="ul8194236156"></a><ul id="ul8194236156"><li>功能说明：协议类型</li><li>取值范围：icmp、tcp、udp或IP协议号</li><li>约束：为空表示支持所有协议。</li></ul>
    </td>
    </tr>
