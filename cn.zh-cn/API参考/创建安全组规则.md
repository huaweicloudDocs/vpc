...
-   请求参数
    ...
    **表 1**  请求参数
    ...
    <td class="cellrowborder" valign="top" width="20.3%" headers="mcps1.2.5.1.3 "><p id="p11677013103332"><a name="p11677013103332"></a><a name="p11677013103332"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="38.99%" headers="mcps1.2.5.1.4 "><p id="p25738233102826"><a name="p25738233102826"></a><a name="p25738233102826"></a>安全组规则对象</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 2**  security\_group\_rule字段说明
    ...
    <td class="cellrowborder" valign="top" width="38.99%" headers="mcps1.2.5.1.4 "><a name="ul741241411519"></a><a name="ul741241411519"></a><ul id="ul741241411519"><li>功能说明：出入控制方向</li><li>取值范围：egress，ingress</li></ul>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="20.3%" headers="mcps1.2.5.1.3 "><p id="p43795239103711"><a name="p43795239103711"></a><a name="p43795239103711"></a>int</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="20.3%" headers="mcps1.2.5.1.3 "><p id="p22362584103937"><a name="p22362584103937"></a><a name="p22362584103937"></a>int</p>
    </td>
...
-   响应参数
    ...
    <table><thead align="left"><tr id="row101573199489"><th class="cellrowborder" valign="top" width="23.09%" id="mcps1.1.4.1.1"><p id="p444890459489"><a name="p444890459489"></a><a name="p444890459489"></a>名称</p>
    </th>
    <th class="cellrowborder" valign="top" width="22.14%" id="mcps1.1.4.1.2"><p id="p437522139489"><a name="p437522139489"></a><a name="p437522139489"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="54.769999999999996%" id="mcps1.1.4.1.3"><p id="p578362329489"><a name="p578362329489"></a><a name="p578362329489"></a>说明</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="row449165309489"><td class="cellrowborder" valign="top" width="23.09%" headers="mcps1.1.4.1.1 "><p id="p268266119489"><a name="p268266119489"></a><a name="p268266119489"></a>security_group_rule</p>
    </td>
    <td class="cellrowborder" valign="top" width="22.14%" headers="mcps1.1.4.1.2 "><p id="p630794179489"><a name="p630794179489"></a><a name="p630794179489"></a><em id="i144346359489"><a name="i144346359489"></a><a name="i144346359489"></a>字典数据结构</em></p>
    </td>
    <td class="cellrowborder" valign="top" width="54.769999999999996%" headers="mcps1.1.4.1.3 "><p id="p349251459489"><a name="p349251459489"></a><a name="p349251459489"></a>安全组规则对象</p>
    </td>
    </tr>
    </tbody>
    </table>

    **表 3**  security\_group\_rules对象
