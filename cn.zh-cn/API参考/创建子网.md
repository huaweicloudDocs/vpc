# 创建子网<a name="ZH-CN_TOPIC_0020090590"></a>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p58892473"><a name="p58892473"></a><a name="p58892473"></a>项目ID</p>
</td>
</tr>
</tbody>
</table>
...
-   请求参数
    ...
    **表 2**  请求参数
    ...
    <td class="cellrowborder" valign="top" width="19.17%" headers="mcps1.2.5.1.3 "><p id="p1015820015639"><a name="p1015820015639"></a><a name="p1015820015639"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="49.44%" headers="mcps1.2.5.1.4 "><p id="p2335287515639"><a name="p2335287515639"></a><a name="p2335287515639"></a>子网对象</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 3**  subnet字段说明
    ...
    <table><thead align="left"><tr id="row36936550"><th class="cellrowborder" valign="top" width="22%" id="mcps1.2.5.1.1"><p id="p39070558"><a name="p39070558"></a><a name="p39070558"></a>名称</p>
    </th>
    <th class="cellrowborder" valign="top" width="16%" id="mcps1.2.5.1.2"><p id="p10598606"><a name="p10598606"></a><a name="p10598606"></a>是否必选</p>
    </th>
    ...
    <tbody><tr id="row12674872"><td class="cellrowborder" valign="top" width="22%" headers="mcps1.2.5.1.1 "><p id="p20031746"><a name="p20031746"></a><a name="p20031746"></a>name</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.2 "><p id="p11958757"><a name="p11958757"></a><a name="p11958757"></a>是</p>
    </td>
    ...
    <tr id="row33189039"><td class="cellrowborder" valign="top" width="22%" headers="mcps1.2.5.1.1 "><p id="p3957675"><a name="p3957675"></a><a name="p3957675"></a>cidr</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.2 "><p id="p52136226"><a name="p52136226"></a><a name="p52136226"></a>是</p>
    </td>
    ...
    <tr id="row24692740"><td class="cellrowborder" valign="top" width="22%" headers="mcps1.2.5.1.1 "><p id="p53954942"><a name="p53954942"></a><a name="p53954942"></a>gateway_ip</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.2 "><p id="p8274172"><a name="p8274172"></a><a name="p8274172"></a>是</p>
    </td>
    ...
    <tr id="row60429346"><td class="cellrowborder" valign="top" width="22%" headers="mcps1.2.5.1.1 "><p id="p62938818"><a name="p62938818"></a><a name="p62938818"></a>dhcp_enable</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.2 "><p id="p64879470"><a name="p64879470"></a><a name="p64879470"></a>否</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="46%" headers="mcps1.2.5.1.4 "><a name="ul18877710204319"></a><a name="ul18877710204319"></a><ul id="ul18877710204319"><li>功能说明：子网是否开启dhcp功能</li><li>取值范围：true（开启），false（关闭）</li><li>约束：不填时默认为true。当设置为false时，会导致新创建的ECS无法获取IP地址，cloudinit无法注入账号密码，请谨慎操作。</li></ul>
    </td>
    </tr>
    <tr id="row10232270"><td class="cellrowborder" valign="top" width="22%" headers="mcps1.2.5.1.1 "><p id="p23507505"><a name="p23507505"></a><a name="p23507505"></a>primary_dns</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.2 "><p id="p25059790"><a name="p25059790"></a><a name="p25059790"></a>否</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="46%" headers="mcps1.2.5.1.4 "><a name="ul12206161414435"></a><a name="ul12206161414435"></a><ul id="ul12206161414435"><li>功能说明：子网dns服务器地址1</li><li>约束：ip格式</li></ul>
    </td>
    </tr>
    <tr id="row45988614"><td class="cellrowborder" valign="top" width="22%" headers="mcps1.2.5.1.1 "><p id="p34090260"><a name="p34090260"></a><a name="p34090260"></a>secondary_dns</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.2 "><p id="p9847715"><a name="p9847715"></a><a name="p9847715"></a>否</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="46%" headers="mcps1.2.5.1.4 "><a name="ul59230186430"></a><a name="ul59230186430"></a><ul id="ul59230186430"><li>功能说明：子网dns服务器地址2</li><li>约束：ip格式</li></ul>
    </td>
    </tr>
    <tr id="row1596910210505"><td class="cellrowborder" valign="top" width="22%" headers="mcps1.2.5.1.1 "><p id="p1842890810505"><a name="p1842890810505"></a><a name="p1842890810505"></a>dnsList</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.2 "><p id="p1634655410505"><a name="p1634655410505"></a><a name="p1634655410505"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.3 "><p id="p4900246410505"><a name="p4900246410505"></a><a name="p4900246410505"></a>List</p>
    </td>
    <td class="cellrowborder" valign="top" width="46%" headers="mcps1.2.5.1.4 "><a name="ul32521424144310"></a><a name="ul32521424144310"></a><ul id="ul32521424144310"><li>功能说明：子网dns服务器地址的集合；如果想使用两个以上dns服务器，请使用该字段</li><li>约束：是子网dns服务器地址1跟子网dns服务器地址2的合集的父集</li></ul>
    </td>
    </tr>
    <tr id="row66578044"><td class="cellrowborder" valign="top" width="22%" headers="mcps1.2.5.1.1 "><p id="p24112512"><a name="p24112512"></a><a name="p24112512"></a>availability_zone</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.2 "><p id="p6956456"><a name="p6956456"></a><a name="p6956456"></a>否</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="46%" headers="mcps1.2.5.1.4 "><a name="ul14409122710438"></a><a name="ul14409122710438"></a><ul id="ul14409122710438"><li>功能说明：子网所在的可用分区标识</li><li>约束：系统存在的可用分区标识</li></ul>
    </td>
    </tr>
    <tr id="row53182860"><td class="cellrowborder" valign="top" width="22%" headers="mcps1.2.5.1.1 "><p id="p12844374"><a name="p12844374"></a><a name="p12844374"></a>vpc_id</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.2 "><p id="p33761356"><a name="p33761356"></a><a name="p33761356"></a>是</p>
    </td>
...
-   请求样例
    ...
    ```
    {
        "subnet": {
            ...
            "availability_zone": "aa-bb-cc",//假设可用分区标识为aa-bb-cc
...
-   响应参数
    ...
    **表 4**  响应参数
    ...
    <td class="cellrowborder" valign="top" width="25.509999999999998%" headers="mcps1.2.4.1.2 "><p id="p5206127615737"><a name="p5206127615737"></a><a name="p5206127615737"></a><em id="i6589830815737"><a name="i6589830815737"></a><a name="i6589830815737"></a>字典数据结构</em></p>
    </td>
    <td class="cellrowborder" valign="top" width="56.15%" headers="mcps1.2.4.1.3 "><p id="p3616274015737"><a name="p3616274015737"></a><a name="p3616274015737"></a>子网对象</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 5**  subnet字段说明
    ...
    <td class="cellrowborder" valign="top" width="49.89%" headers="mcps1.2.4.1.3 "><p id="p55028720"><a name="p55028720"></a><a name="p55028720"></a>子网名称</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="49.89%" headers="mcps1.2.4.1.3 "><p id="p9487824"><a name="p9487824"></a><a name="p9487824"></a>子网的网段</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="49.89%" headers="mcps1.2.4.1.3 "><p id="p52252659"><a name="p52252659"></a><a name="p52252659"></a>子网的网关</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="21.25%" headers="mcps1.2.4.1.2 "><p id="p65014446105649"><a name="p65014446105649"></a><a name="p65014446105649"></a>List</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="49.89%" headers="mcps1.2.4.1.3 "><p id="p44463652175257"><a name="p44463652175257"></a><a name="p44463652175257"></a>子网所在的可用分区标识</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="49.89%" headers="mcps1.2.4.1.3 "><p id="p34538004103221"><a name="p34538004103221"></a><a name="p34538004103221"></a>对应网络(原生Openstack接口)id</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="49.89%" headers="mcps1.2.4.1.3 "><p id="p15608450104010"><a name="p15608450104010"></a><a name="p15608450104010"></a>对应子网(原生Openstack接口)id</p>
    </td>
    </tr>
    </tbody>
    </table>
