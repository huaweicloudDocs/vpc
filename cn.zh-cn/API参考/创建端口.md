# 创建端口<a name="zh-cn_topic_0133195886"></a>
...
-   请求参数
    ...
    **表 3**  port字段说明
    ...
    <td class="cellrowborder" valign="top" width="41.83581641835816%" headers="mcps1.2.5.1.4 "><p id="p1789745621520"><a name="p1789745621520"></a><a name="p1789745621520"></a><a href="获取项目ID.md">项目ID</a>。</p>
    </td>
    </tr>
...
-   响应参数
    ...
    **表 8**  port字段说明
    ...
    <td class="cellrowborder" valign="top" width="18.86188618861886%" headers="mcps1.2.4.1.2 "><p id="p737862619493"><a name="p737862619493"></a><a name="p737862619493"></a>Array of strings</p>
    </td>
