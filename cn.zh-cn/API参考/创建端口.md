# 创建端口<a name="ZH-CN_TOPIC_0030591297"></a>

## 功能介绍<a name="zh-cn_topic_0030591053_section49785318"></a>

创建端口。

## URL<a name="section4410043510236"></a>
...
-   请求参数
    ...
    **表 1**  请求参数
    ...
    <td class="cellrowborder" valign="top" width="19.74%" headers="mcps1.2.5.1.3 "><p id="p24610700155949"><a name="p24610700155949"></a><a name="p24610700155949"></a><em id="i1444157416014"><a name="i1444157416014"></a><a name="i1444157416014"></a>字典数据结构</em></p>
    </td>
    <td class="cellrowborder" valign="top" width="47.18%" headers="mcps1.2.5.1.4 "><p id="p23134126155949"><a name="p23134126155949"></a><a name="p23134126155949"></a>端口对象</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 2**  port字段说明
    ...
    <th class="cellrowborder" valign="top" width="13.91%" id="mcps1.2.5.1.2"><p id="p37178096"><a name="p37178096"></a><a name="p37178096"></a>是否必选</p>
    </th>
    <th class="cellrowborder" valign="top" width="13.350000000000001%" id="mcps1.2.5.1.3"><p id="p4463230517346"><a name="p4463230517346"></a><a name="p4463230517346"></a>参数类型</p>
    </th>
    ...
    <td class="cellrowborder" valign="top" width="13.91%" headers="mcps1.2.5.1.2 "><p id="p52686031"><a name="p52686031"></a><a name="p52686031"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.350000000000001%" headers="mcps1.2.5.1.3 "><p id="p5844694317346"><a name="p5844694317346"></a><a name="p5844694317346"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="13.91%" headers="mcps1.2.5.1.2 "><p id="p31753649"><a name="p31753649"></a><a name="p31753649"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.350000000000001%" headers="mcps1.2.5.1.3 "><p id="p3658194617346"><a name="p3658194617346"></a><a name="p3658194617346"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="13.91%" headers="mcps1.2.5.1.2 "><p id="p12588822101254"><a name="p12588822101254"></a><a name="p12588822101254"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.350000000000001%" headers="mcps1.2.5.1.3 "><p id="p44080050101254"><a name="p44080050101254"></a><a name="p44080050101254"></a>Bool</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="13.91%" headers="mcps1.2.5.1.2 "><p id="p5535815810130"><a name="p5535815810130"></a><a name="p5535815810130"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.350000000000001%" headers="mcps1.2.5.1.3 "><p id="p11367102143014"><a name="p11367102143014"></a><a name="p11367102143014"></a>List[Dict]</p>
    </td>
    <td class="cellrowborder" valign="top" width="41.54%" headers="mcps1.2.5.1.4 "><a name="ul2381036113010"></a><a name="ul2381036113010"></a><ul id="ul2381036113010"><li>功能说明：端口IP</li><li>约束：一个端口只支持一个fixed_ip，且不支持更新</li></ul>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="13.91%" headers="mcps1.2.5.1.2 "><p id="p29410313102712"><a name="p29410313102712"></a><a name="p29410313102712"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.350000000000001%" headers="mcps1.2.5.1.3 "><p id="p28361787102712"><a name="p28361787102712"></a><a name="p28361787102712"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="41.54%" headers="mcps1.2.5.1.4 "><p id="p19651161913413"><a name="p19651161913413"></a><a name="p19651161913413"></a>项目ID。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="13.91%" headers="mcps1.2.5.1.2 "><p id="p7611876102716"><a name="p7611876102716"></a><a name="p7611876102716"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.350000000000001%" headers="mcps1.2.5.1.3 "><p id="p29934598102716"><a name="p29934598102716"></a><a name="p29934598102716"></a>List</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="13.91%" headers="mcps1.2.5.1.2 "><p id="p26050504102815"><a name="p26050504102815"></a><a name="p26050504102815"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.350000000000001%" headers="mcps1.2.5.1.3 "><p id="p42007479102815"><a name="p42007479102815"></a><a name="p42007479102815"></a>List</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="13.91%" headers="mcps1.2.5.1.2 "><p id="p36628411102851"><a name="p36628411102851"></a><a name="p36628411102851"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.350000000000001%" headers="mcps1.2.5.1.3 "><p id="p40227789102851"><a name="p40227789102851"></a><a name="p40227789102851"></a>List</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="13.91%" headers="mcps1.2.5.1.2 "><p id="p115143195250"><a name="p115143195250"></a><a name="p115143195250"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.350000000000001%" headers="mcps1.2.5.1.3 "><p id="p95149195256"><a name="p95149195256"></a><a name="p95149195256"></a>Bool</p>
    </td>
...
-   响应参数
    ...
    **表 7**  port字段说明
    ...
    <td class="cellrowborder" valign="top" width="48.25%" headers="mcps1.2.4.1.3 "><p id="p213203394120"><a name="p213203394120"></a><a name="p213203394120"></a>项目ID。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="15.509999999999998%" headers="mcps1.2.4.1.2 "><p id="p4272181823016"><a name="p4272181823016"></a><a name="p4272181823016"></a>Bool</p>
    </td>
