...
-   请求参数
    ...
    **表 3**  port字段说明
    ...
    <tr id="row1736452613492"><td class="cellrowborder" valign="top" width="31.626837316268368%" headers="mcps1.2.5.1.1 "><p id="p123651726114919"><a name="p123651726114919"></a><a name="p123651726114919"></a>security_groups</p>
    </td>
    ...
    **表 6**  extra\_dhcp\_opt对象
    ...
    <td class="cellrowborder" valign="top" width="47.96%" headers="mcps1.2.5.1.4 "><p id="p1837018266499"><a name="p1837018266499"></a><a name="p1837018266499"></a>DHCP选项名称，目前仅支持填写“51”，表示DHCP租约时间。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="47.96%" headers="mcps1.2.5.1.4 "><p id="p16433722151515"><a name="p16433722151515"></a><a name="p16433722151515"></a>DHCP选项的值。</p>
...
-   响应参数
    ...
    **表 8**  port字段说明
    ...
    <td class="cellrowborder" valign="top" width="18.86188618861886%" headers="mcps1.2.4.1.2 "><p id="p9375192620494"><a name="p9375192620494"></a><a name="p9375192620494"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="18.86188618861886%" headers="mcps1.2.4.1.2 "><p id="p237662694912"><a name="p237662694912"></a><a name="p237662694912"></a><a href="#table72371439857">binding:vif_details</a> object</p>
    </td>
    <td class="cellrowborder" valign="top" width="48.484848484848484%" headers="mcps1.2.4.1.3 "><p id="p7238155916178"><a name="p7238155916178"></a><a name="p7238155916178"></a>vif的详细信息，参见<a href="#table72371439857">表12</a></p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="48.484848484848484%" headers="mcps1.2.4.1.3 "><a name="ul8590174216481"></a><a name="ul8590174216481"></a><ul id="ul8590174216481"><li>功能说明：主网卡默认内网域名信息</li><li>约束：不支持设置和更新，由系统自动维护</li></ul>
    </td>
    </tr>
    ...
    <tr id="row19425152719166"><td class="cellrowborder" valign="top" width="32.653265326532654%" headers="mcps1.2.4.1.1 "><p id="p17425122741618"><a name="p17425122741618"></a><a name="p17425122741618"></a>zone_id</p>
    </td>
    <td class="cellrowborder" valign="top" width="18.86188618861886%" headers="mcps1.2.4.1.2 "><p id="p742572714161"><a name="p742572714161"></a><a name="p742572714161"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="48.484848484848484%" headers="mcps1.2.4.1.3 "><p id="p7425192719164"><a name="p7425192719164"></a><a name="p7425192719164"></a>端口所属的可用分区</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 10**  allow\_address\_pair对象
    ...
    <p id="p3649194610490"><a name="p3649194610490"></a><a name="p3649194610490"></a>约束：不支持0.0.0.0/0</p>
